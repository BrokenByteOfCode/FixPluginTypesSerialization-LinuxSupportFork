...
namespace FixPluginTypesSerialization.UnityPlayer.Structs.v2019.v4.v37
{
    [StructLayout(LayoutKind.Explicit)]
    public struct MonoManagerStruct
    {
        [FieldOffset(0x210)] public DynamicArrayData m_AssemblyNames;
    }

    [ApplicableToUnityVersionsSince("2019.4.37")]
